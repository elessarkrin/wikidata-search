                        ...
                        for (var j in entity.claims) {
                            ...
                            if (prop && val && propType) {
                                ...
                                if (!resolveProperties)
                                    ...
                                    claims.push({'property': prop, 'value': moment(val).utcOffset(0).format('Do MMMM YYYY'), 'time': val, 'type': propType, 'propertyCached' : propertyCached, 'valueCached' : valueCached });
